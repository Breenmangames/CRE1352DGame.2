...
public class Spawntest_Desert : MonoBehaviour
{
    ...
    public LayerMask desertGrassLayer;
    ...
    // Tries to determine a good spawn position when the player is on/near a desert grass tile.
    ...
    public bool TryGetEncounterSpawnPosition(out Vector3 spawnPosition)
    {
        ...
        Collider2D hit = Physics2D.OverlapCircle(playerWorldPos, detectionRadius, desertGrassLayer);
