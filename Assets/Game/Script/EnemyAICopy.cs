...
public class EnemyAICopy : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        PlayerControllerCopy playerControllerCopy = FindFirstObjectByType<PlayerControllerCopy>();
        if (playerControllerCopy != null)
        {
            target = playerControllerCopy.transform;
            player = playerControllerCopy.gameObject;
        }
        else
        {
    ...
    {
        PlayerControllerCopy playerControllerCopy = other.gameObject.GetComponent<PlayerControllerCopy>();
        if (playerControllerCopy != null)
        {
            playerControllerCopy.ChangeHealth(-1);
        }
    }
...
void FireProjectile()
{
    ...
    void PerformAttack()
    {
        ...
        {
            PlayerControllerCopy playerControllerCopy = target.GetComponent<PlayerControllerCopy>();
            if (playerControllerCopy != null)
            {
                playerControllerCopy.ChangeHealth(-1);
            }
